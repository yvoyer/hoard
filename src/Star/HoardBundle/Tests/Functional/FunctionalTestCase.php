...
class FunctionalTestCase extends \PHPUnit_Extensions_Database_TestCase
{
    /**
    ...
    protected function getDataSetYml($file)
    {
        return new \PHPUnit_Extensions_Database_DataSet_YamlDataSet($file);
    }

    protected function getDataSetComposite(array $datasets = array())
    {
    ...
    protected function getConnection()
    {
        ...
        return new \PHPUnit_Extensions_Database_DB_DefaultDatabaseConnection($connection);
    }
    ...
    {
        if (null === $this->client) {
            throw new \RuntimeException("The client is not loaded");
        }
